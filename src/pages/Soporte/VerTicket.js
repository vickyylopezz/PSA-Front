...
const VerTicket = (props) => {
  const { readOnly, esTicketError, ticketId, codigoProducto, version } = props;
  ...
  return (
    <>
      ...
      <Typography variant="h5" align="center" component="h2" gutterBottom>
        Ticket {ticketId} - Producto {codigoProducto} (Versión {version})
      </Typography>
      <Form
              ...
              <Grid container alignItems="flex-start" spacing={2}>
                <Grid item xs={12}>
                  <FormControl component="fieldset">
                    ...
                    >
                      <FormControlLabel value="consulta" control={<Radio />} label="Consulta" disabled={true} />
                      <FormControlLabel value="error" control={<Radio />} label="Error" disabled={true} />
                    </RadioGroup>
                  </FormControl>
                </Grid>
                <Grid item xs={12}>
      ...
      <div style={{ marginTop: 16 }}>
        <Button variant="contained"
          ...
          size="small"
          style={{ marginLeft: 16 }}
          onClick={() => history.push('/ver-tickets')}>Volver</Button>
      </div>
    </>
  );
}
